...
2. Can adversarial debiasing — jointly optimising a sentiment classifier and a demographic discriminator — significantly reduce these gaps?
3. What trade-offs emerge between aggregate accuracy and subgroup-level fairness?
...
1. **Data Collection** (optional — dataset already provided): Open `notebooks/RedditPostsScraping.ipynb` and configure your Reddit API credentials (PRAW).

2. **Full Experiment Pipeline**: Open `notebooks/ThesisComplete.ipynb` in Google Colab or Jupyter.
